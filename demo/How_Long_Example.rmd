...
ona.R makes is easy to download and work with datasets on [ona](http://ona.io). If you haven't read the [basics document](http://SEL-Columbia.github.com/ona.R/demo/Basics_of_ona.R.html), I recommend that you read that first. In this showcase, we will demonstrate how to figure out how long enumerators take to enter survey data, and correlate completion time with enumerator and date of survey. 
...
# install.packages(c("stringr","ggplot2")) if you don't have ggplot2 or stringr installed yet
library(stringr)
