...
After learning to [read ona datasets into R](http://SEL-Columbia.github.com/ona.R/demo/Basics_of_ona.R.html), you may want to take a few steps in cleaning your data. In this example, we'll learn step-by-step how to select the variables, paramaters and desired values for outlier elimination. 
